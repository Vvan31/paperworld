...
import eventLogoESP from "../public/assets/APW spanish.svg";
import eventLogoENG from "../public/assets/APW english.svg";
...
const HomePage = () => {
  ...
  return (
    <>
     <Head>
        <title>Americas Paper World - Expo papelera en Mexico</title>
        <meta name="description" content="Exposición papelera de primer nivel y clase mundial que reúne profesionales de la industria del papel y maquinaria con el objetivo de mostrar avances tecnológicos para la fabricación de celulosa y papel." />
